   ...
   return (
      <div className="flex flex-col items-center justify-center flex-1">
         ...
         <div className="flex flex-col items-center justify-center md:flex-row">
            <button className="w-40 px-6 py-1 mx-2 mt-20 font-semibold tracking-wider text-white uppercase rounded shadow font-primary bg-green-mimi focus:outline-none focus:underline">
               Cambiar Plan
            </button>
            <button className="w-40 px-6 py-1 mx-2 mt-6 font-semibold tracking-wider text-white uppercase bg-red-500 rounded shadow md:mt-20 font-primary focus:outline-none focus:underline">
               Cancelar Cuenta
            </button>
         </div>
      </div>
